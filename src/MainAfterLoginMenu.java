...
public class MainAfterLoginMenu {
    ...
    private final FridgeMenu fridgeMenu;
    private final EatingOutMenu eatingOutMenu;

    public MainAfterLoginMenu(User user, Scanner sc) {
        this.user = user;
        this.userService = new UserService();
        this.fridgeService = new FridgeService(user);
        this.eatingOutService = new EatingOutService(user);        
        ...
        this.fridgeMenu = new FridgeMenu(fridgeService, userService, user, sc);
        this.eatingOutMenu = new EatingOutMenu(eatingOutService, userService, user, sc);
    }
    ...
    public void run() {
        ...
        while (true) {
            ...
            System.out.println("6. 외식 메뉴 열기");            
            System.out.println("7. 이번 달 통계 보기");
